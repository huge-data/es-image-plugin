...
/**
 * 复制 {@link TermQuery}, 首先根据hash查询，并且只计算匹配docs的得分
 */
public class ImageHashQuery extends Query {
	...
	final class ImageHashWeight extends Weight {
		...
		public ImageHashWeight(IndexSearcher searcher, TermContext termStates) throws IOException {
	...
	public ImageHashQuery(Term t, String luceneFieldName, LireFeature lireFeature, ImageScoreCache imageScoreCache,
			float boost) {
		this.term = t;
	...
	public boolean equals(Object o) {
		...
		return (this.getBoost() == other.getBoost()) && this.term.equals(other.term)
				& luceneFieldName.equals(luceneFieldName) && lireFeature.equals(lireFeature);
	}
